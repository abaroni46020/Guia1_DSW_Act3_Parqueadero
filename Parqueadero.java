...
public class Parqueadero {
    ...
    /**
     * Método de extensión 1: Indica la placa del carro que lleva más tiempo en el parqueadero.
     *
     * @return Respuesta 1.
     */
    public String metodo1() {
        String respuesta1="";
        int horaLlegada = HORA_CIERRE;
        int disponible=0;
        //for (int i = 0; i < TAMANO; i++) {
        for (Puesto puesto: puestos) {
            if (puesto.estaOcupado()) {
                ...
                if (carro.darHoraLlegada() <= horaLlegada) {
                    ...
                    respuesta1 = "La placa del carro que ha estado durante más tiempo en el parqueadero es: " + carro.darPlaca();
                }
            } else {
                disponible++;
            }
        ...
        if (disponible == 40) {
            respuesta1 = "El parqueadero está vacío.";
        }
        return respuesta1;
    }

    /**
     * Método de extensión 2: Indica si el parqueadero está lleno o tiene puestos disponibles.
     *
     * @return Respuesta 2.
     */
    public String metodo2() {
        //int disponible = 0;
        int disponible = NO_HAY_PUESTO;
        String respuesta2 = "El parqueadero está lleno.";
        //for (int i = 0;i < 40 && cont == 0;i++){
        for (int i = 0;i < TAMANO && disponible == NO_HAY_PUESTO;i++){
            if (!puestos[i].estaOcupado()){
